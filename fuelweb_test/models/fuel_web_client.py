...
class FuelWebClient(object):
    ...
    def get_plugin_id(self, cluster_id, plugin_name, version):
        ...
        for i in xrange(len(plugin_versions)):
            if plugin_versions[i]['metadata']['plugin_version'] == version:
                plugin_id = plugin_versions[i]['metadata']['plugin_id']
                break
        return plugin_id
