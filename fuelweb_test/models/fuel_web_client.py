...
class FuelWebClient(object):
    ...
    def check_ceph_time_skew(self, cluster_id, offline_nodes):
        ...
        with self.environment.ssh_manager.get_remote(
    ...
    def check_ceph_status(self, cluster_id, offline_nodes=(),
        ...
        for node in online_ceph_nodes:
            with self.environment.ssh_manager\
                    .get_remote(node['ip']) as remote:
                try:
        ...
        with self.environment.ssh_manager.get_remote(node['ip']) as remote:
