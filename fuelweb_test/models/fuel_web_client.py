...
from fuelweb_test.settings import ADMIN_PXE_INTERFACE
...
class FuelWebClient(object):
    ...
    def update_node_networks(self, node_id, interfaces_dict,
        ...
        if ADMIN_PXE_INTERFACE not in get_bond_ifaces():
            interfaces_dict[ADMIN_PXE_INTERFACE] = \
                interfaces_dict.get(ADMIN_PXE_INTERFACE, [])
            if 'fuelweb_admin' not in interfaces_dict[ADMIN_PXE_INTERFACE]:
                interfaces_dict[ADMIN_PXE_INTERFACE].append('fuelweb_admin')
