    ...
    def replace_release_repos(self, release_name):
        ...
        if release_data["state"] == "available":
            ...
            if release_data["operating_system"] == "Ubuntu":
                ...
                logger.info("Unknown Operating System for release %s: '%s'."
                            " Repository list not updated")
        else:
            logger.info("Release %s: '%s' is unavailable. Repository list not"
                        " updated")
