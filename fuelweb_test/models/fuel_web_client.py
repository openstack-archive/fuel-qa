...
class FuelWebClient(object):
    ...
    @logwrap
    def assert_cluster_floating_list(self, cluster_id, expected_ips):
        logger.info('Assert floating IPs on cluster #{}. Expected %s'.format(
            cluster_id, expected_ips))
        current_ips = self.get_cluster_floating_list(cluster_id)
    ...
    @logwrap
    def get_cluster_floating_list(self, cluster_id):
        logger.info('Get floating IPs list at cluster #{}'.format(cluster_id))
