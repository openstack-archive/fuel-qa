...
class FuelWebClient(object):
    ...
    def assert_ostf_run_certain(self, cluster_id, tests_must_be_passed,
                                timeout=10 * 60):
        """Wait for finish of running OSTF tests, check that specified
           in [tests_must_be_passed] tests are passed"""
    ...
    def assert_ostf_run(self, cluster_id, should_fail=0, failed_test_name=None,
        ...
        """Waiting for finish of running OSTF tests, check that there is no
           failed tests. If [failed_test_name] tests are expected, check that
    ...
    def return_ostf_results(self, cluster_id, timeout, test_sets):
        """Filter and return OSTF results for futher analysis"""
