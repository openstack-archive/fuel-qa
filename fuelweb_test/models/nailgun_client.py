...
class NailgunClient(object):
    ...
    @logwrap
    @json_parse
    def get_components(self, id=None):
        ...
        endpoint = endpoint + '/{}'.format(id) if id else endpoint
    ...
    @logwrap
    @json_parse
    def get_envirionments(self, id=None):
    ...
    @logwrap
    @json_parse
    def get_global_resource_value(self, env_id, resource, effective=False):
        """ Get global resource value for specified env and resource

        :param env_id:  str or int
        :param resource:str or int
    ...
    @logwrap
    @json_parse
    def get_node_resource_value(self, env_id, resource, node_id,
                                effective=False):
