...
class NailgunClient(object):
    ...
    def __init__(self, admin_node_ip, **kwargs):
        ...
        self.__endpoint_filter = {'service_type': 'fuel'}
    ...
    def client(self):
        warn(
            'client is deprecated in favor of session and will be dropped',
            DeprecationWarning)
        return self._client
    ...
    def get_ostf_test_sets(self, cluster_id):
        return self._get(
            ...
            endpoint_override={'service_type': 'ostf'}
        ).json()
    ...
    def ostf_run_singe_test(self, cluster_id, test_sets_list, test_name):
        ...
        return self._post(
            "/testruns",
            json=data,
            endpoint_override={'service_type': 'ostf'}).json()
    # ## /OSTF ###
