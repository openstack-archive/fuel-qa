...
class EnvironmentModel(object):
    ...
    def setup_environment(self, custom=settings.CUSTOM_ENV,
        ...
        logger.info('!!!!!!!!!!!!!!!!!!!!! change conf')
        cmd = "sed -i -e 's/listen   8000;/#listen  8000;/g' /etc/nginx/conf.d/nailgun.conf"

        self.nailgun_actions.execute_in_container(command=cmd, container='nginx')
