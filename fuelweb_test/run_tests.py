...
def import_tests():
    ...
    from tests.tests_deployments.tests_neutron_vlan import test_scale_vlan_group_5  # noqa
    from tests.tests_deployments.tests_neutron_tun import test_scale_tun_group_5  # noqa
