...
def import_tests():
    ...
    from tests.tests_deployments.tests_neutron_vlan import test_murano_os_component  # noqa
    from tests.tests_deployments.tests_neutron_vlan import test_sahara_os_component  # noqa
