...
def import_tests():
    ...
    from tests.tests_deployments.tests_neutron_vlan import test_ha_group_1  # noqa
    from tests.tests_deployments.tests_neutron_vlan import test_ha_group_2  # noqa
