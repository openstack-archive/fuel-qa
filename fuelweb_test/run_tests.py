...
def import_tests():
    ...
    from tests.tests_upgrade import test_os_upgrade  # noqa
    # from tests.tests_upgrade import test_clone_env  # noqa
    # from tests.tests_upgrade import test_node_reassignment  # noqa
