...
def main():
    ...
    if not test_plan:
        ...
        description = urlparse.urljoin(s.JENKINS['url'], url)
        test_plan = client.add_plan(test_plan_name,
                                    description=description,
                                    milestone_id=milestone['id'],
                                    entries=[])
        LOG.info('The test plan has been created.'.format(test_plan_name))
    else:
        LOG.info('The test plan found.'.format(test_plan_name))
    ...
    LOG.info('Uploading the tests results to TestRail...')
