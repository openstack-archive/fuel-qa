...
def mark_all_tests_as_inprogress(client, tests_suite):
    """This function marks all Tempest tests as inprogress and returns the list
    with TestResult objects. Each TestResult object corresponds to one of
    the tests.
    """
...
def main():
    ...
    parser.add_option('-f', '--fail-all-tests', dest='all_tests_blocked',
                      action='store_true', help='Mark all Tempest tests as '
                                                'blocked regardless of '
                                                'genuine results')
    parser.add_option('-a', '--all-tests-inprogress',
                      dest='all_tests_inprogress', action='store_true',
                      help='Mark all Tempest tests as inprogress '
    ...
    if options.all_tests_blocked:
        ...
        test_results = mark_all_tests_as_inprogress(client, tests_suite)
    else:
