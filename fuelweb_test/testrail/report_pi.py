...
def main():
    ...
    logger.info(TestRailSettings.tests_suite)
    ...
    for run_one in runs:
        ...
        for os in operation_systems:
            if os['distro'] in tests_job['name'].lower()
    ...
    run_name = 'Partner Integration tests'
    ...
    for mile in tests_results.keys():
        for iso_number in tests_results[mile].keys():
            ...
            run_structure = project.test_run_struct(name=run_name,
            ...
            plan_entries = []
            # Uznaem vse testcase v ukazanom tests_suite
            ...
            run = find_run_by_name_and_config(test_plan, run_name)
            if not run:
            ...
            for os in operation_systems:
                ...
                tests_results[mile][iso_number] = publish_results(
                    project=project,
                    milestone_id=milestone['id'],
                    test_plan=test_plan,
                    suite_id=tests_suite['id'],
