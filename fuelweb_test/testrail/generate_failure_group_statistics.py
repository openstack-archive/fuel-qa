...
import tablib
import xmltodict
from fuelweb_test.testrail.settings import JENKINS, LaunchpadSettings
from fuelweb_test.testrail.settings import logger, TestRailSettings
...
def get_testrail_data():
    ...
    project = [i for i in projects
               if i.get('name') == TestRailSettings.project][0]
...
def main():
    ...
    testrail_bugs = get_bugs(subbuilds, testrail_testdata)s
