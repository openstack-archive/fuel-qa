...
class UbuntuBootstrapBuild(TestBasic):
    ...
    def build_simple_bootstrap(self):
        ...
        with self.env.d_env.get_admin_remote() as remote:
            ...
            ubuntu_repo = bootstrap_default_params["MIRROR_DISTRO"]
            mos_repo = bootstrap_default_params["MIRROR_MOS"]
    ...
    def build_full_bootstrap(self):
        ...
        with self.env.d_env.get_admin_remote() as remote:
            ...
            temp_script = self.create_tempfile_with_content(
                textwrap.dedent(bootstrap_script))
            remote.upload(temp_script.name, "/root/bin/bootstrap_script.sh")
