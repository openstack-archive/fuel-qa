...
class TestMultipleClusterNets(TestBasic):
    ...
    def deploy_controllers_from_custom_nodegroup(self):
        ...
        Scenario:
            ...
            4. Configure its networks (floating ranges and ALL VIPs must be
        ...
        #tmp
        logger.info('Devops networks:')
        for nodegroup in NODEGROUPS:
            logger.info(nodegroup['name'])
            for pool in nodegroup['pools']:
                logger.info(pool)
                logger.info(self.env.d_env.get_network(name=pool).ip)
        #tmp
        ...
        # todo: current settings -> new_settings
        new_settings = []

        #todo: need change this?
        new_settings['vips']['vrouter_pub']['ipaddr'] = '10.109.16.2' # todo: from public2
        new_settings['vips']['management']['ipaddr'] = '10.109.17.3' # todo: from management2
        new_settings['vips']['public']['ipaddr'] = '10.109.16.3' # todo: from pyblic2
        new_settings['vips']['vrouter']['ipaddr'] = '10.109.17.2' # todo: from management2
        #todo: or this?
        new_settings['vips']['public_vrouter_vip'] = '10.109.16.2' # todo: from public2
        new_settings['vips']['management_vrouter_vip'] = '10.109.17.2' # todo: from management2
        new_settings['vips']['management_vip'] = '10.109.17.3' # todo: from pyblic2
        new_settings['vips']['public_vip'] = '10.109.16.3' # todo: from management2

        #todo: floating
        new_settings['networking_parameters']['floating_ranges']['0']['0'] = '10.109.16.128' #todo: ip from public2
        new_settings['networking_parameters']['floating_ranges']['0']['1'] = '10.109.16.254' #todo: ip from public2
        ...
        #self.fuel_web.update_cluster_network(self, cluster_id, new_settings)
