...
class TestMultipleClusterNets(TestBasic):
    ...
    @staticmethod
    def change_default_admin_range(networks, exclude_first_ips):
        ...
        new_admin_range = [default_admin_range[0] + exclude_first_ips,
    ...
    def deploy_ceph_ha_nodegroups(self):
        ...
        new_admin_range = self.change_default_admin_range(networks,
                                                          exclude_first_ips=10)
