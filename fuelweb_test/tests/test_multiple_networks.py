...
class TestMultipleClusterNets(TestBasic):
    ...
    def deploy_controllers_from_custom_nodegroup(self):
        ...
        Scenario:
            ...
            11. Run OSTF
            12. Delete cluster
            13. Check nodes from custom nodegroup can't bootstrap
        ...
        wait(
            ...
            self.fuel_web.is_node_discovered(nailgun_nodes[1]) and
            self.fuel_web.is_node_discovered(nailgun_nodes[2]) and
            self.fuel_web.is_node_discovered(nailgun_nodes[3]) and
            self.fuel_web.is_node_discovered(nailgun_nodes[4]),
            timeout=15 * 60,
            interval=15
        )
