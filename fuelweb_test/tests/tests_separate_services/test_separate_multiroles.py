    ...
    def separate_all_service(self):
        ...
        self.fuel_web.update_nodes(
            cluster_id,
            {
                ...
                'slave-02': ['controller'],
                'slave-03': ['controller'],
                'slave-04': ['standalone-database', 'rabbit',
                             'standalone-rabbitmq', 'horizon'],
                'slave-05': ['standalone-database', 'rabbit',
                             'standalone-rabbitmq', 'horizon'],
                'slave-06': ['standalone-database', 'rabbit',
                             'standalone-rabbitmq', 'horizon'],
                'slave-07': ['compute'],
                'slave-08': ['cinder']
            }
