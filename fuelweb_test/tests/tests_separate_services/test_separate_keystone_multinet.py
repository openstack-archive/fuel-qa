...
@test(groups=["separate_services_multiple_networks"])
class SeparateKeystone(TestBasic):
    ...
    def separate_keystone_service(self):
        ...
        Duration 120m
        Snapshot separate_keystone_service_multiple_networks
        """
        ...
        def install_plugins():
            ...
            for plugin in (
                ...
                self.env.admin_actions.upload_plugin(plugin=plugin)
        ...
        self.show_step(5)
        self.env.bootstrap_nodes(self.env.d_env.nodes().slaves[4:5])
        ...
        self.env.make_snapshot("separate_keystone_service_multiple_networks")
