...
class ReleasePluginGroup1(TestBasic):
    ...
    def deploy_with_fuel_library_plugin(self):
        ...
        """
        if not settings.FUEL_RELEASE_PLUGIN_PATH:
        ...
        utils.upload_tarball(
            ...
            tar_path=settings.FUEL_RELEASE_PLUGIN_PATH,
            tar_target="/var")
        ...
        self.show_step(3)
        assert_true(output['stdout'].contains('fuel-library'))
