...
class TestMixedReposBase(TestBasic):
    ...
    def test_mixed_repos(
            self, roles_to_add, cluster_settings={}):
        ...
        repos_new =\
            [rep for rep in repos if rep['name'] not in self.update_repos]

        attributes = \
            {'editable': {'repo_setup': {'repos': {'value': repos_new}}}}
