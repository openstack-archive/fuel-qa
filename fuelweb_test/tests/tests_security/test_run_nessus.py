...
class TestNessus(test_neutron_tun.NeutronTunHaBase):
    ...
    @test(depends_on=[base_test_case.SetupEnvironment.prepare_slaves_5],
          groups=["deploy_neutron_tun_ha_nessus", "nessus"])
    ...
    @test(depends_on=[deploy_neutron_tun_ha_nessus],
          groups=["nessus_cpa", "nessus_fuel_master_cpa", "nessus"])
    ...
    @test(depends_on=[deploy_neutron_tun_ha_nessus],
          groups=["nessus_wat", "nessus_fuel_master_wat", "nessus"])
    ...
    @test(depends_on=[deploy_neutron_tun_ha_nessus],
          groups=["nessus_cpa", "nessus_controller_ubuntu_cpa", "nessus"])
