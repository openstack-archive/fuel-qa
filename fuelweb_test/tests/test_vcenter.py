    ...
    def vcenter_add_delete_nodes(self):
        ...
        Scenario:
            ...
            27. Add 1 node with compute role, 1 node with cinder role and
                redeploy cluster.
            28. Run network verification.
            29. Run OSTF.
            30. Add 3 node with controller role and redeploy cluster.
            31. Run network verification.
            32. Run OSTF.
            33. Remove 1 node with controller role and redeploy cluster.
            34. Run OSTF.
