...
class VcenterDeploy(TestBasic):
    ...
    def vcenter_bvt(self):
        ...
        vmcompute_name = self.node_name('slave-04')
        self.configure_nova_vlan(cluster_id)
        self.fuel_web.vcenter_configure(
            cluster_id, multiclusters=True, vmglance=True,
            target_node=vmcompute_name
        )
        ...
        # FIXME when bugs #1482166 and  #1475346 will be fixed.
    ...
    def vcenter_ceilometer(self):
        ...
        vmcompute_name_1 = self.node_name('slave-04')
        vmcompute_name_2 = self.node_name('slave-05')

        # Set manual configuration for vcenter
        vcenter_value = {
            "glance": {
                "vcenter_username": "",
                "datacenter": "",
                ...
                {"vcenter_username": VCENTER_USERNAME,
                 "nova_computes": [
                     {"datastore_regex": ".*",
                      ...
                      "target_node": {
                          "current": {"id": vmcompute_name_1,
                                      "label": vmcompute_name_1},
                     ...
                     {"datastore_regex": ".*",
                      ...
                      "target_node": {
                          "current": {"id": vmcompute_name_2,
                                      "label": vmcompute_name_2},
                          "options": [{"id": "controllers",
                                       "label": "controllers"}, ]}
                      }
                 ],
