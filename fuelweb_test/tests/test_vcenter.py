...
class VcenterDeploy(TestBasic):
    ...
    @test(depends_on=[SetupEnvironment.prepare_slaves_9],
          groups=["multiroles", "vcenter_nodes_with_multiroles_cindervmdk_and_cinder"])
    @log_snapshot_after_test
    def vcenter_nodes_with_multiroles_cindervmdk_and_cinder(self):
    ...
    @test(depends_on=[SetupEnvironment.prepare_slaves_9],
          groups=["multiroles", "vcenter_ceph_nodes_with_multiroles_cindervmdk_and_cephosd"])
    @log_snapshot_after_test
    def vcenter_ceph_nodes_with_multiroles_cindervmdk_and_cephosd(self):
    ...
    @test(depends_on=[SetupEnvironment.prepare_slaves_9],
          groups=["multiroles", "vcenter_ceilometer_nodes_with_multiroles_cindervmdk_and_mongodb"])
    @log_snapshot_after_test
    def vcenter_ceilometer_nodes_with_multiroles_cindervmdk_and_mongodb(self):
