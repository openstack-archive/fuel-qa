...
class TestNetworkTemplates(TestNetworkTemplatesBase, DataDrivenUpgradeBase):
    ...
    def __init__(self):
        ...
        self.source_snapshot_name = "upgrade_smoke_net_tmpl"
        self.snapshot_name = "upgrade_smoke_net_tmpl"
        assert_not_equal(
