...
class HaScaleRemoveAddController(TestBasic):
    ...
    def delete_add_controller(self):
        ...
        def get_cluster_status(cluster, allow_partially_deploy):
            """This function instead fuel_web.check_cluster_status method."""
            cluster_info = self.client.get_cluster(cluster)
        ...
        wait(lambda: get_cluster_status(
            cluster_id, False), timeout=60 * 15)
