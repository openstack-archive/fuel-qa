...
class TestHaNeutronScalability(TestBasic):
    ...
    def neutron_tun_scalability(self):
        ...
        logger.info("STEP4: Check swift on primary controller {0}".format(
            primary_node))
        common.rebalance_swift_ring(primary_node)
        ...
        logger.info("STEP7: Check swift on primary controller {0}".format(
            primary_node_s3))
        common.rebalance_swift_ring(primary_node_s3)
        ...
        common.rebalance_swift_ring(primary_node_s9)
        ...
        common.rebalance_swift_ring(primary_node_s14)
