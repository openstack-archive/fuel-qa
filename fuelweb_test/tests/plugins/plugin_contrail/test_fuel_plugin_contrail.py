...
class ContrailPlugin(TestBasic):
    ...
    def deploy_controller_compute_contrail(self):
        ...
        net = Common(controller_ip=contr_ip, user='admin', password='admin', tenant='admin')
        ...
        self.fuel_web.run_ostf(
            ...
            should_fail=2,
            failed_test_name=[
                ('Check network connectivity from instance via floating IP', 'Launch instance with file injection')
            ]
        )
