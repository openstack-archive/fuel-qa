...
class ContrailPlugin(TestBasic):
    ...
    def deploy_controller_compute_contrail(self):
        ...
        remote.execute("source /root/openrc && neutron net-create net04 "
                       "&& neutron subnet-create net04 "
                       "10.100.0.0/24 --name subnet04")

        # Tests using north-south connectivity are expected to fail because
        # they require additional gateway nodes, and specific contrail settings.
        # This mark is a workaround until it will be verified and tested manually.
