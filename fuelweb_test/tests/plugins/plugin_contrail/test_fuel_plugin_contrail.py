...
class ContrailPlugin(TestBasic):
    ...
    def deploy_controller_compute_contrail(self):
        ...
        Scenario:
            1. Revert snapshot "install_contrail"
            2. Create cluster
            3. Add 3 nodes with Operating system role, 1 node with controller role
        ...
        self.env.make_snapshot("deploy_controller_compute_contrail", is_make=True)
