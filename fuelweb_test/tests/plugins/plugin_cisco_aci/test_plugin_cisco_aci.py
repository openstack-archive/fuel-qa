...
CISCO_ACI_FUEL_MASTER_NODE = '10.109.0.2'
...
basic_ml2_conf_settings.append("type_drivers = local,flat,vlan,gre,vxlan")
basic_ml2_conf_settings.append("tenant_network_types = vlan")
basic_ml2_conf_settings.append("network_vlan_ranges =physnet2:1000:1030")
basic_ml2_conf_settings.append("enable_security_group = True")
basic_ml2_conf_settings.append("firewall_driver=neutron.agent.linux."
                               "iptables_firewall."
                               "OVSHybridIptablesFirewallDriver")
basic_ml2_conf_settings.append("integration_bridge=br-int")
basic_ml2_conf_settings.append("bridge_mappings=physnet2:br-prv")
basic_ml2_conf_settings.append("enable_tunneling=False")
basic_ml2_conf_settings.append("polling_interval=2")
basic_ml2_conf_settings.append("l2_population=False")
basic_ml2_conf_settings.append("arp_responder=False")

basic_neutron_conf_settings = []
basic_neutron_conf_settings.append("admin_tenant_name = admin")
basic_neutron_conf_settings.append("admin_user = admin")
basic_neutron_conf_settings.append("admin_password = admin")
...
gbp_neutron_conf_settings.append("servicechain_drivers=simplechain_driver")
gbp_neutron_conf_settings.append("default_quota = -1")
gbp_neutron_conf_settings.append("quota_network = -1")
gbp_neutron_conf_settings.append("quota_subnet = -1")
gbp_neutron_conf_settings.append("quota_port = -1")
gbp_neutron_conf_settings.append("quota_security_group = -1")
gbp_neutron_conf_settings.append("quota_security_group_rule = -1")
gbp_neutron_conf_settings.append("quota_router = -1")
gbp_neutron_conf_settings.append("quota_floatingip = -1")

gbp_heat_conf_settings = []
gbp_heat_conf_settings.append("plugin_dirs=/usr/lib/python2.7/site-packages/"
                              "gbpautomation/heat")
...
class CiscoAciPlugin(TestBasic):
    ...
    def deploy_cisco_aci_plugin_disabled(self):
        ...
        if 'cisco_aci' in attr['editable']:
            ...
            pl_ntp['value'] = CISCO_ACI_FUEL_MASTER_NODE
...
##############################################################################
    ...
    def deploy_cisco_aci_plugin_gbp_apic_ml2(self):
       ...
       Use Case 4 (2b) GBP module and APIC ML2 driver with static config
        ...
        commands = []
        commands.append("dpkg -l | grep neutron-ml2-driver-apic")
        commands.append(ls_command)
        self.check_by_ssh("slave-02", commands)
        commands.append("dpkg -l | grep apicapi")
        commands.append("dpkg -l | grep 'group-based-policy '")
...
##############################################################################
    ...
    def deploy_cisco_aci_plugin_gbp_apic_gbp_lldp_pre_net(self):
       ...
       Use Case 10 GBP module and APIC GBP driver with static configuration
        ...
        cmd_err.append("cat /etc/neutron/plugins/ml2/ml2_conf_cisco.ini |"
