...
from fuelweb_test.settings import VCENTER_DVS_SWITCH
...
class TestDVSPlugin(TestBasic):
    ...
    def enable_plugin(self, cluster_id=None):
        ...
        options = {'metadata/enabled': True,
                   'vmware_dvs_net_maps/value': VCENTER_DVS_SWITCH}
    ...
    def dvs_vcenter_ceph(self):
        ...
        Scenario:
            1. Create cluster
            2. Add 3 node with controller role
            3. Add 1 node with cinder-vmdk role +ceph-osd
            4. Add 1 node with compute role +ceph-osd
            5. Deploy the cluster
            6. Run OSTF
    ...
    def dvs_vcenter_ceilometer(self):
        ...
        Scenario:
            1. Create cluster
            2. Add 3 node with controller role + mongo
            5. Deploy the cluster
            6. Run OSTF
    ...
    @test(depends_on=[SetupEnvironment.prepare_slaves_5],
          groups=["dvs_vcenter_add_delete_nodes"])
    @log_snapshot_after_test
    def dvs_vcenter_add_delete_nodes(self):
        ...
        Scenario:
            ...
            3. Add 1 node with cinder-vmdk role
            4. Add 1 node with compute role
            5. Remove node with cinder-vmdk role.
            6. Add node with cinder role
            7. Redeploy cluster.
            8. Run OSTF
            9. Remove node with compute role
            10. Add node with cinder-vmdk  role
            11. Redeploy cluster.
            12. Run OSTF
