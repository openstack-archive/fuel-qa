...
class TestDVSPlugin(TestBasic):
    ...
    def dvs_vcenter_smoke(self):
        ...
        self.create_vms(os_conn=os_conn, vm_count=2, nics=nics)
    ...
    @test(depends_on=[SetupEnvironment.prepare_slaves_5],
          groups=["dvs_vcenter_ceph2", "dvs_vcenter_plugin"])
    @log_snapshot_after_test
    def dvs_vcenter_ceph2(self):
        """Deploy cluster with plugin and ceph backend
        ...
        Scenario:
            ...
            6. Add 1 node with cinder-vmware.
            7. Deploy the cluster.
            8. Run OSTF.
