...
class ExamplePluginPostDeploy(TestBasic):
    ...
    @test(
        ...
        groups=[
            "deploy_ha_one_controller_neutron_example_late",
            "deploy_ha_one_controller_neutron_example_after_create"])
    @log_snapshot_after_test
    def deploy_ha_one_controller_neutron_example_after_create(self):
        ...
        Duration 35m
        Snapshot deploy_ha_one_controller_neutron_example_after_create
        """
