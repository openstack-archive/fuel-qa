...
class ExamplePluginPostDeploy(TestBasic):
    ...
    @test(depends_on=[deploy_ha_one_controller_neutron_example_install_after_create],
          groups=["deploy_ha_one_controller_neutron_example_late",
    ...
    def deploy_ha_one_controller_neutron_example_enable_after_create(self):
        ...
        self.show_step(2)
        self.deploy_cluster(cluster_id)
        self.fuel_web.deploy_cluster_wait(cluster_id)
    ...
    @test(depends_on=[deploy_ha_one_controller_neutron_example_install_after_deploy],
          groups=["deploy_ha_one_controller_neutron_example_late",
                  "deploy_ha_one_controller_neutron_example_enable_after_create"])
    @log_snapshot_after_test
