...
class ExamplePluginPostDeploy(TestBasic):
    ...
    @test(depends_on=[SetupEnvironment.prepare_slaves_3],
          groups=["deploy_ha_one_controller_neutron_example_late",
                  "deploy_ha_one_controller_neutron_example_no_enable"])
    @log_snapshot_after_test
    def deploy_ha_one_controller_neutron_example_no_enable(self):
        ...
        Duration 35m
        Snapshot deploy_ha_one_controller_neutron_example_no_enable
        """
        def install_plugin():
    ...
    @test(depends_on=[deploy_ha_one_controller_neutron_example_no_enable],
          groups=["deploy_ha_one_controller_neutron_example_late",
                  "deploy_ha_one_controller_neutron_example_enable"])
    @log_snapshot_after_test
    def deploy_ha_one_controller_neutron_example_enable(self):
        """Deploy cluster with one controller and example plugin
        ...
        Duration 35m
        Snapshot deploy_ha_one_controller_neutron_example_enable
        """
    ...
    @test(depends_on=[SetupEnvironment.prepare_slaves_3],
          groups=["deploy_ha_one_controller_neutron_example_late",
                  "deploy_ha_one_controller_neutron_example_no_enable"])
    @log_snapshot_after_test
    def deploy_ha_one_controller_neutron_example_after_deploy(self):
        """Deploy cluster with one controller and example plugin
        ...
        Scenario:
            ...
            7. Install plugin
            8. Enable plugin
            9. Re-Deploy the cluster
            10. Run network verification
            11. Check plugin health
            12. Run OSTF
