...
class ExamplePlugin(TestBasic):
    ...
    def deploy_ha_one_controller_neutron_example_v3(self):
        ...
        checkers.check_file_exists(res_node_01,
                                   'plugin+100.0.all',
                                   '/tmp')
        checkers.check_file_exists(res_node_01,
                                   'plugin+100.all',
        ...
        checkers.check_log_lines_order(res_node_01,
                                       '/var/log/puppet.log',
                                       netconfig_str,
                                       plugin_str)
        checkers.check_log_lines_order(res_node_01,
        ...
        checkers.check_file_exists(res_node_02,
                                   'plugin+100.0.all',
                                   '/tmp')
        checkers.check_file_exists(res_node_02,
                                   'plugin+100.all',
        ...
        checkers.check_file_exists(res_node_03,
                                   'plugin+100.0.all',
                                   '/tmp')
        checkers.check_file_exists(res_node_03,
                                   'plugin+100.all',
