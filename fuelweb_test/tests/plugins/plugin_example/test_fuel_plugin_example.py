...
class ExamplePlugin(TestBasic):
    ...
    def deploy_ha_one_controller_neutron_example_v3(self):
        ...
        slave1 = self.fuel_web.get_nailgun_node_by_base_name('slave-01')
        ...
        # plugin+100.0.all
        # plugin+100.al
        slave2 = self.fuel_web.get_nailgun_node_by_base_name('slave-02')
        ...
        slave3 = self.fuel_web.get_nailgun_node_by_base_name('slave-03')
