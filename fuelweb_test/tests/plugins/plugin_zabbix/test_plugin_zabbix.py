...
class ZabbixPlugin(TestBasic):
    ...
    def __init__(self):
        ...
        check_plugin_path_env(
            plugin_name='ZABBIX_PLUGIN_PATH',
    ...
    def deploy_zabbix_snmptrap_ha(self):
        ...
        """
        check_plugin_path_env(
            plugin_name='ZABBIX_SNMP_PLUGIN_PATH',
    ...
    def deploy_zabbix_snmp_emc_ha(self):
        ...
        check_plugin_path_env(
            plugin_name='ZABBIX_SNMP_EMC_PLUGIN_PATH',
            plugin_path=settings.ZABBIX_SNMP_EMC_PLUGIN_PATH
        )
