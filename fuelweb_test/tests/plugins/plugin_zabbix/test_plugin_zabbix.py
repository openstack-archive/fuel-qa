...
class ZabbixPlugin(TestBasic):
    ...
    def deploy_zabbix_ha(self):
        ...
        pub_network_assignment = attr['editable']['public_network_assignment']
        pub_network_assignment['value'] = True
        pub_network_assignment['assign_to_all_nodes']['value'] = True
        attr['editable']['common']['auto_assign_floating_ip']['value'] = True
