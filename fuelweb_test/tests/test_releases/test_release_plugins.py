...
class ReleasePluginTests(TestBasic):
    ...
    @staticmethod
    def yaml_path():
        return '/root/fuel-plugins/release-plugin/metadata.yaml'
    ...
    def install_release_plugin(self):
        ...
        create_plug_cmd = 'cd fuel-plugins; fpb --create release-plugin ' \
                          ...
                          '/etc/puppet/mitaka-9.0/ --nailgun-path ' \
        ...
        with YamlEditor(self.yaml_path(),
                        ip=self.ssh_manager.admin_ip) as editor:
            release_name = [r['name'] for r in editor.content['releases']
