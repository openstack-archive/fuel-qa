...
class TestVirtRole(TestBasic):
    ...
    def spawn_one_vm_on_one_virt_node(self):
        ...
        Duration: 60m
        Snapshot: ready_one_virt_one_vm
        """

        self.env.revert_snapshot("ready_with_1_slaves")
        self.check_run("ready_one_virt_one_vm")
        ...
        # NOTE(dkalashnik): VM memory is measured in Gb,
        # so convert slave_node_memory to Gb and set VM memory to
        # half of this calculated value.
        self.fuel_web.client.create_vms_nodes(
            node_id,
            [{
                "id": 1,
                "mem": settings.HARDWARE["slave_node_memory"] / 2048,
                "cpu": settings.HARDWARE["slave_node_cpu"]
            }])
        ...
        self.env.make_snapshot("ready_one_virt_one_vm", is_make=True)
    ...
    def spawn_three_vms_across_three_virt_nodes(self):
        ...
        Duration: 60m
        Snapshot: ready_three_virts_three_vms
        """

        self.env.revert_snapshot("ready_with_3_slaves")
        self.check_run("ready_three_virts_three_vms")
        ...
        self.env.make_snapshot("ready_three_virts_three_vms", is_make=True)
