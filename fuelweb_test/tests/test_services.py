...
class CeilometerHAOneControllerMongo(OSTFCeilometerHelper):
    ...
    @test(depends_on=[SetupEnvironment.prepare_slaves_3],
          groups=["deploy_ceilometer_ha_one_controller_with_mongo_neutron"])
    @log_snapshot_after_test
    def deploy_ceilometer_ha_one_controller_with_mongo_neutron(self):
        ...
        Duration 45m
        Snapshot: deploy_ceilometer_ha_one_controller_with_mongo_neutron
        """
        self.env.revert_snapshot("ready_with_3_slaves")
        ...
        self.env.make_snapshot(
            "deploy_ceilometer_ha_one_controller_with_mongo_neutron")

    @test(depends_on=[SetupEnvironment.prepare_slaves_3],
          groups=["deploy_ceilometer_ha_one_controller_multirole_nova"])
    @log_snapshot_after_test
    def deploy_ceilometer_ha_one_controller_multirole_nova(self):
        """Deploy cluster in ha multirole mode with Ceilometer and
           Nova Network
        ...
        Duration 35m
        Snapshot: deploy_ceilometer_ha_one_controller_multirole_nova
        """
        self.env.revert_snapshot("ready_with_3_slaves")
        ...
        self.run_tests(cluster_id)
        self.env.make_snapshot(
            "deploy_ceilometer_ha_one_controller_multirole_nova")


@test(groups=["services", "services.ceilometer", "services_ha.ceilometer"])
class CeilometerHAMongo(OSTFCeilometerHelper):
    @test(depends_on=[SetupEnvironment.prepare_slaves_5],
          groups=["deploy_ceilometer_ha_with_mongo_neutron_gre"])
    @log_snapshot_after_test
    def deploy_ceilometer_ha_with_mongo_neutron_gre(self):
        """Deploy cluster in ha mode with Ceilometer and Neutron GRE
        ...
        Duration 65m
        Snapshot: deploy_ceilometer_ha_with_mongo_neutron_gre
        ...
        self.env.make_snapshot("deploy_ceilometer_ha_with_mongo_neutron_gre")

    @test(depends_on=[SetupEnvironment.prepare_slaves_5],
          groups=["deploy_ceilometer_ha_multirole_neutron_vlan"])
    @log_snapshot_after_test
    def deploy_ceilometer_ha_multirole_neutron_vlan(self):
        ...
        Duration 80m
        Snapshot: deploy_ceilometer_ha_multirole_neutron_vlan
        ...
        self.run_tests(cluster_id)
        self.env.make_snapshot("deploy_ceilometer_ha_multirole_neutron_vlan")

    @test(depends_on=[SetupEnvironment.prepare_slaves_5],
          groups=["deploy_ceilometer_ha_with_external_mongo_nova_net"])
    @log_snapshot_after_test
    def deploy_ceilometer_ha_with_external_mongo_nova_net(self):
        ...
        Duration 65m
        Snapshot: deploy_ceilometer_ha_with_external_mongo_nova_net
        ...
        self.run_tests(cluster_id)
        self.env.make_snapshot(
            "deploy_ceilometer_ha_with_external_mongo_nova_net")
