...
class SaharaHAOneControllerExternal(TestBasic):
    ...
    def deploy_sahara_ha_one_controller_tun_external(self):
        ...
        Scenario:
            1. Revert snapshot with sahara env on one controller
            2. Verify Sahara service on controller
            3. Run all sanity and smoke tests
            4. Register images for Sahara
            5. Run scenario tests for Sahara
...
class SaharaHAExternal(TestBasic):
    ...
    def deploy_sahara_ha_tun_external(self):
        ...
        Scenario:
            1. Revert snapshot with sahara HA
            2. Verify Sahara service on all controllers
            3. Run all sanity and smoke tests
            4. Register images for Sahara
            5. Run scenario tests for Sahara
