...
class SaharaHAOneControllerExternal(TestBasic):
    ...
    def deploy_sahara_ha_one_controller_tun_external(self):
        ...
        cmd = (
            ...
            "cd sahara && "
            "echo 'cuncurrency: 2' >> "
            "etc/scenario/sahara-ci/credentials.yaml.mako && "
            "tox -e scenario -- -V ~/templatesvar.ini "
            "etc/scenario/sahara-ci" % self.fuel_web.get_public_vip(
                cluster_id))
