...
class CeilometerHAMongo(OSTFCeilometerHelper):
    ...
    @test(depends_on=[SetupEnvironment.prepare_slaves_5],
          groups=["deploy_ceilometer_ha_add_mongo"])
    @log_snapshot_after_test
    def deploy_ceilometer_ha_add_mongo(self):
        ...
        Duration 80m
        Snapshot: deploy_ceilometer_ha_add_mongo
        ...
        self.env.make_snapshot("deploy_ceilometer_ha_add_mongo")
