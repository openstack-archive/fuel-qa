...
class TestL3AgentVlan(base.TestNeutronBase):
    ...
    @test(
        depends_on=[
            test_neutron.TestNeutronFailoverVlan.deploy_ha_neutron_vlan],
        groups=["test_ban_l3_agents_and_clear_one_vlan",
                "test_ban_l3_agents_and_clear_one"])
    @log_snapshot_after_test
    def test_ban_l3_agents_and_clear_one_vlan(self):
        """Ban all l3-agents, clear one of them and check health of l3-agent
        ...
        """
        self.env.revert_snapshot("deploy_ha_neutron_vlan")
        self.check_ban_l3_agents_and_clear_one()
...
class TestL3AgentGRE(base.TestNeutronBase):
    ...
    @test(
        depends_on=[
            test_neutron.TestNeutronFailoverGRE.deploy_ha_neutron_gre],
        groups=["test_ban_l3_agents_and_clear_one_gre",
                "test_ban_l3_agents_and_clear_one"])
    @log_snapshot_after_test
    def test_ban_l3_agents_and_clear_one_gre(self):
        """Ban all l3-agents, clear one of them and check health of l3-agent
...
class TestL3AgentVxlan(base.TestNeutronBase):
    ...
    @test(
        depends_on=[
            test_neutron.TestNeutronFailoverVxlan.deploy_ha_neutron_vxlan],
        groups=["test_ban_l3_agents_and_clear_one_vxlan",
                "test_ban_l3_agents_and_clear_one"])
    @log_snapshot_after_test
    def test_ban_l3_agents_and_clear_one_vxlan(self):
        """Ban all l3-agents, clear one of them and check health of l3-agent
