...
class TestNeutronBase(test_neutron_base.TestNeutronFailoverBase):
    ...
    def create_network_and_vm(self, hostname, suffix, zone, ext_network,
                              instance_keypair, security_group, router):
        ...
        :param ext_network: external network to bind with router
