...
class PartitionPreservation(TestBasic):
    ...
    def cinder_nova_partition_preservation(self):
        ...
        Scenario:
            ...
            3. Create an OS instance
            4. Mark 'cinder' partition to be preserved
            5. Mark 'vm' partition to be preserved
            6. Reinstall the compute node
            7. Run network verification
            8. Run OSTF
            9. Verify that the volume is present and has 'available' status
               after the node reinstallation
               the created VM
            10. Verify that the VM is available and pingable
               after the node reinstallation
