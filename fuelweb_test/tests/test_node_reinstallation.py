...
class ErrorNodeReinstallation(TestBasic):
    ...
    def _get_failed_deployment(self, cluster_id, node):
        """Fail deployment to get cluster in the error state
        ...
        logger.info('Deployment failed on {}'.format(node['name']))
        # enable ruby
    ...
    def reinstall_failed_primary_controller_deployment(self):
        ...
        Scenario:
            1. Revert the snapshot
            2. Start deployment; for primary controller get a failure of
               deployment
    ...
    def reinstall_failed_regular_controller_deployment(self):
        ...
        Scenario:
            1. Revert the snapshot
            2. Start deployment; for a regular controller get a failure of
               deployment
            3. Reinstall the cluster
            4. Run network verification
            5. Run OSTF
        ...
        regular_ctrl = self.fuel_web.get_nailgun_node_by_name('slave-02')
        self._get_failed_deployment(cluster_id, regular_ctrl)
    ...
    def reinstall_failed_compute_deployment(self):
        ...
        Scenario:
            1. Revert the snapshot
            2. Start deployment; for one of computes get a failure of
               deployment
            3. Reinstall the cluster
            4. Run network verification
            5. Run OSTF
        ...
        self._get_failed_deployment(cluster_id, cmps_nailgun[0])
