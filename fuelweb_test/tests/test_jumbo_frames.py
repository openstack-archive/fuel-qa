...
class TestJumboFrames(base_test_case.TestBasic):
    ...
    def jumbo_frames_neutron_gre(self):
        """Deploy cluster in ha mode with 3 controllers and Neutron GRE
        ...
        Duration 120m
        Snapshot ready_jumbo_frames_neutron_gre
        ...
        self.check_mtu_size_between_instances(mtu_offset=42)
        self.env.make_snapshot("ready_jumbo_frames_neutron_gre")
