...
class HaTunGroup1(TestBasic):
    ...
    Includes:
        ...
        3. No storage for volumes, Ceph for Images and ephemeral, changed
    ...
    def tun_ceph_for_images_and_objects(self):
        ...
        Scenario:
            ...
            3. Add 2 nodes with compute role
            4. Add 1 node with cinder role
            5. Add 2 nodes with ceph OSD role
            6. Verify networks
    ...
    @test(depends_on=[SetupEnvironment.prepare_slaves_9],
          groups=["tun_no_volumes_ceph_images_ephemeral"])
    @log_snapshot_after_test
    def tun_ceph_for_images_and_objects(self):
        ...
        Duration XXXm
        Snapshot tun_no_volumes_ceph_images_ephemeral
        """
        self.env.revert_snapshot("ready_with_9_slaves")
        ...
        self.fuel_web.verify_network(cluster_id)
        self.fuel_web.run_ostf(cluster_id=cluster_id)
        self.env.make_snapshot("tun_no_volumes_ceph_images_ephemeral")
