...
class HaTunGroup3(TestBasic):
    ...
    def tun_no_volumes_ceph_for_images_and_ephemeral(self):
        ...
        Scenario:
            ...
            8. Change default dns server to any 2 public dns servers
               to the 'Host OS DNS Servers' on Settings tab
            9. Change default ntp servers to any 2 public ntp servers
               to the 'Host OS NTP Servers' on Settings tab
            10. Change default public net mask from /24 to /25
            11. Verify networks
            12. Deploy cluster
            13. Verify networks
            14. Run OSTF
