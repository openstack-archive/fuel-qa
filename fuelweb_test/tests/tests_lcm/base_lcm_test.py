...
class SetupLCMEnvironment(LCMTestBasic):
    ...
    def deploy_1_ctrl_1_cmp_1_cinder(self):
        ...
        """
        self.check_run("1_ctrl_1_cmp_1_cinder")
        ...
        self.show_step(7)
        self.env.make_snapshot("deploy_1_ctrl_1_cmp_1_cinder", is_make=True)
        if GENERATE_FIXTURES:
            self.generate_fixture("deploy_1_ctrl_1_cmp_1_cinder")
    ...
    def deploy_1_ctrl_1_cmp_1_mongo(self):
        ...
        """
        self.check_run("1_ctrl_1_cmp_1_mongo")
        self.show_step(1, initialize=True)
        self.env.revert_snapshot("ready_with_3_slaves")
        ...
        self.fuel_web.deploy_cluster_wait(cluster_id)
        self.show_step(7)
        self.env.make_snapshot("deploy_1_ctrl_1_cmp_1_mongo", is_make=True)
        if GENERATE_FIXTURES:
            self.generate_fixture("deploy_1_ctrl_1_cmp_1_mongo")
    ...
    def deploy_1_ctrl_1_cmp_3_ceph(self):
        ...
        """
        self.check_run("1_ctrl_1_cmp_3_ceph")
        self.show_step(1, initialize=True)
        ...
        self.fuel_web.deploy_cluster_wait(cluster_id)
        self.show_step(7)
        self.env.make_snapshot("deploy_1_ctrl_1_cmp_3_ceph", is_make=True)
        if GENERATE_FIXTURES:
            self.generate_fixture("deploy_1_ctrl_1_cmp_3_ceph")
