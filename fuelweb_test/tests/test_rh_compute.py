...
class RhHA(TestBasic):
    ...
    def deploy_rh_based_compute(self):
        ...
        with self.env.get_ssh_to_remote(target_node_ip) as remote:
        ...
        with self.env.d_env.get_admin_remote() as remote_admin:
            with self.env.get_ssh_to_remote(target_node_ip) as \
                    remote_slave:
        ...
        with self.env.get_ssh_to_remote(controller_ip) as remote:
