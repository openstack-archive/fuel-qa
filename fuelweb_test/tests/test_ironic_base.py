...
class TestIronicDeploy(TestBasic):
    ...
    def _swift_rings_rebalance(self, cluster_id):
        ...
        for node in controller_nodes:
            self.ssh_manager.execute_on_remote(ip=node['ip'], cmd=cmd)
            time.sleep(60)
        time.sleep(600)
    ...
    def deploy_scale_controller_ironic(self):
        ...
        Scenario:
            ...
            8. Add 1 Controller node
            9. Add 1 Controller+Ironic node
            10. Redeploy the cluster
            11. Run OSTF tests
            12. Boot, check connectivity, delete Ironic VM
            13. Remove 1 Controller node
            14. Remove 1 Controller+Ironic node
