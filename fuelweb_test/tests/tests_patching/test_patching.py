...
class PatchingMasterTests(TestBasic):
    ...
    def patching_master(self):
        ...
        Scenario:
        1. Revert snapshot of deployed master
        2. Run Rally benchmark tests and store results
        3. Download patched packages on master node and make local repositories
        4. Perform actions required to apply patches
        5. Verify that fix works
        6. Run OSTF
        7. Run Rally benchmark tests and compare results

        Duration 15m
        Snapshot patching_master
        """
