...
class CommandLineRoleTests(test_cli_base.CommandLine):
    ...
    def cli_delete_role(self):
        ...
        Scenario:
            ...
            4. Create new file "role.yaml" and paste the above:
               meta:
                 conflicts:
                   - controller
                   - compute
            ...
            8. Add new nodes to the environment: controller, compute
            9. Go to the console and try to delete roles:
               fuel role --rel 2 --delete --role <role name from step 4>
