...
class CustomNodeName(TestBasic):
    ...
    def default_hostname(self):
        """Verify that the default hostname (e.g. 'node-1') is applied on nodes
    ...
    def set_custom_hostname(self):
        ...
        for role in ('controller', 'compute'):
            ...
            assert_equal(
                ...
                "Failed to apply the new '{0}' hostname for the '{1}' node. "
                "Current hostname is "
