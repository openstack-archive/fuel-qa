...
class TestCloneEnv(base_test_data.TestBasic):
    ...
    @test(groups=["clone_nonexistent_environment"])
    ...
    @test(groups=["clone_environment_wo_name_in_body"])
    ...
    @test(groups=["clone_environment_wo_release_id_in_body"])
    ...
    @test(groups=["clone_environment_with_empty_body"])
    ...
    @test(groups=["clone_environment_with_too_long_name"])
    def test_clone_with_too_long_name(self):
        ...
        data = {
            "name": "MANYMANYSYMBOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOL",
            "release_id": release_id
        }
    ...
    @test(groups=["clone_environment_with_nonexistent_release_id"])
    ...
    @test(groups=["clone_environment_with_incorrect_release_id"])
    ...
    @test(groups=["double_clone_environment"])
