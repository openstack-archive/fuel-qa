...
class TestHaFlatScalability(TestBasic):
    ...
    def ha_flat_scalability(self):
        ...
        logger.info("Adding new node to the cluster: "
                    "{'slave-01': ['controller']}")
        self.fuel_web.update_nodes(
            cluster_id,
            {
        ...
        logger.info("Adding new nodes to the cluster: "
                    "{'slave-02': ['controller'], "
                    "'slave-03': ['controller']}")
        self.fuel_web.update_nodes(
        ...
        logger.info("Deleting nodes from the cluster: "
                    "{{0}: ['controller'], "
                    "'slave-05': ['controller']}".format(devops_node.name))
        self.fuel_web.update_nodes(
