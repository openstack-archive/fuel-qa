...
class MongoMultirole(TestBasic):
    ...
    @test(depends_on=SetupEnvironment.prepare_slaves_9,
          groups=['mongo_cinder_untag_network_with_ceilometer'])
    @log_snapshot_after_test
    def mongo_cinder_untag_network_with_ceilometer(self):
        ...
        Duration 180m
        Snapshot mongo_cinder_untag_network_with_ceilometer
        """
        ...
        self.env.make_snapshot('mongo_cinder_untag_network_with_ceilometer')
