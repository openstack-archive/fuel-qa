...
class FailoverGroup3(TestBasic):
    ...
    def shutdown_cinder_cluster(self):
        ...
        with self.fuel_web.get_ssh_for_node("slave-01") as ssh:
            ...
            cmd2 = 'ls -la /dev'
            try:
                os.execute_through_host(ssh, floating_ip_1.ip, cmd)
                os.execute_through_host(ssh, floating_ip_1.ip, cmd2)

                os.execute_through_host(ssh, floating_ip_2.ip, cmd)
                os.execute_through_host(ssh, floating_ip_2.ip, cmd2)
