    ...
    def cic_maintenance_mode_single_node(self):
        ...
        for nailgun_node in self.env.d_env.nodes().slaves[0:3]:
            ...
            try:
                ...
                logger.debug('Node {0} do not become offline after '
                             'switching maintenance mode'.format(nailgun_node))
            ...
            try:
                ...
                logger.debug('Node {0} do not become online after exiting '
    ...
    def cic_maintenance_mode_single_node_auto(self):
        ...
        for nailgun_node in self.env.d_env.nodes().slaves[0:3]:
            ...
            try:
                ...
                logger.debug('Node {0} do not become offline after auto '
                             'switching maintenance mode'.format(nailgun_node))
            ...
            try:
                ...
                logger.debug('Node {0} do not become online after '
                             'reboot'.format(nailgun_node))
