...
class OstfRepeatableTests(base_test_case.TestBasic):
    ...
    @test(depends_on=[base_test_case.SetupEnvironment.prepare_slaves_3],
          groups=["create_delete_ip_n_times_neutron"])
    @log_snapshot_after_test
    def create_delete_ip_n_times_neutron(self):
        ...
        Duration 1000m
        Snapshot create_delete_ip_n_times_neutron
        ...
        self.env.make_snapshot("create_delete_ip_n_times_neutron")

    @test(depends_on=[base_test_case.SetupEnvironment.prepare_slaves_3],
          groups=["create_delete_ip_n_times_neutron"])
    @log_snapshot_after_test
    def deploy_create_delete_ip_n_times_neutron(self):
