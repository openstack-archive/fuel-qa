...
class TestHaCephNeutronFailover(TestHaFailoverBase):
    ...
    def ha_ceph_neutron_rabbit_master_destroy(self):
        """Power off rabbit master 2, check cluster, power on nodes, check cluster
        ...
        Scenario:
            ...
            6. Destroy rabbit-master controller
            7. Run OSTF ha suite
            8. Ping created instance
            9. Destroy second rabbit-master controller
            10. Ping created instance
            11. Turn on controller from step 6
            12. Run OSTF ha suite
            13. Ping instance
            14. Turn on controller from step 9
            15. Run OSTF ha suite
            16. Ping instance
            17. Run OSTF

            7. Run OSTF

        Duration TBD duration here
        """
