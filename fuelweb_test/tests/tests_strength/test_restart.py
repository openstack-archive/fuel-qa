...
@test(groups=["deploy_reset_primary_neutron"])
class HAThreeControllerNeutronRestart(TestBasic):
    """HAThreeControllerNeutronRestart."""  # TODO documentation
    ...
    def deploy_reset_primary_neutron(self):
        ...
        self.env.make_snapshot("deploy_reset_primary_neutron", is_make = True)
