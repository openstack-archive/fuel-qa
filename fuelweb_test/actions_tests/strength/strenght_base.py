...
class StrenghtBaseActions(actions_base.ActionsBase):
    ...
    def _action_wait_galera_cluster(self):
        ...
        self.fuel_web.wait_mysql_galera_is_up(
            [n.name for n in set(d_ctrls) - set(self.destoryed_devops_nodes)],
            timeout=300)
    ...
    def _action_check_pacemaker_status(self):
        ...
        n_ctrls = self.fuel_web.get_nailgun_cluster_nodes_by_roles(
            ...
            ['controller'])
        d_ctrls = map(self.fuel_web.get_devops_node_by_nailgun_node, n_ctrls)
        online_d_ctrls = set(d_ctrls) - set(self.destoryed_devops_nodes)
