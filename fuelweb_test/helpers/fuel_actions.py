...
class FuelBootstrapCliActions(BaseActions):
    ...
    def activate_bootstrap_image(self, uuid, notify_webui=False):
        command = \
            ("fuel-bootstrap activate {uuid} {notify_webui}"
             .format(uuid=uuid,
                     notify_webui="--notify-webui" if notify_webui else ""))
        result = ''.join(
