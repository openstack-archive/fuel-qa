...
def setup_teardown(setup=None, teardown=None):
    ...
    ...     print('setup_with_self', self.cls_val, self.val)

    >>> def teardown_with_self(self):
    ...     print('teardown_with_self', self.cls_val, self.val)

    >>> def setup_with_cls(cls):
    ...     print('setup_with_cls', cls.cls_val)

    >>> def teardown_with_cls(cls):
    ...     print('teardown_with_cls', cls.cls_val)
    ...
    ...         print('test_self_ext_self', cls_val, val)
    ...         self.val = val
    ...         self.cls_val = cls_val
    ...     @classmethod
    ...     @setup_teardown(
    ...
    ...     def test_self_ext_cls(cls, cls_val=-2):
    ...         print('test_self_ext_cls', cls_val)
    ...         cls.cls_val = cls_val
    ...     @staticmethod
    ...     @setup_teardown(setup=setup_func, teardown=teardown_func)
    ...     def test_none_none():
    ...
    setup_with_self 2 2
    test_self_ext_self -1 -1
    teardown_with_self -1 -1
