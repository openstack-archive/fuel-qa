...
@logwrap
def store_tasks_list(cluster_id, ssh_manager, nailgun, write_on_disk=False):
    """
    ...
    :param ssh_manager: ssh_manager instance to perform remote work
    ...
    ssh_manager.execute(admin_ip, cmd)
