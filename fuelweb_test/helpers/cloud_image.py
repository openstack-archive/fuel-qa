...
def generate_cloudimage_iso(cloud_image_dir_path,
                            ...
                            meta_data_path):
    gen_cmd = "genisoimage"
    output = "-output {}/cloud_centos.iso".format(cloud_image_dir_path)
    volid_cidata = "-volid cidata"
    joilet = "-joliet"
    data = "-rock {} {}".format(user_data_path, meta_data_path)

    subprocess.check_call([gen_cmd, output, volid_cidata, joilet, data],
