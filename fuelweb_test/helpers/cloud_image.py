...
def generate_cloud_image_iso(d_env, cloud_image_path, admin_network,
                             interface_name, admin_ip, admin_netmask,
                             gateway, dns, dns_ext, hostname, user, password):

    # create dir for meta_data, user_data and cloud_ISO
    dir_path = os.path.dirname(cloud_image_path)
    iso_name = os.path.basename(cloud_image_path)
