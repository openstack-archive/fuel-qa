...
class NodePuppetStatus(object):
    ...
    def print_line(self, task=None, results=None):
        ...
        print("{runtime},{node},{task},{total_time},{change_count},\
                {fail_count},{changes},{failures}".format(
...
class PuppetTaskResponse(object):
...
class AstutePuppetTaskParser(object):
