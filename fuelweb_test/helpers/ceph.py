...
def get_node_fqdns_w_clock_skew(node_name):
    ...
    """
    fqdns = []
    if not is_clock_skew(node_name):
        return fqdns

    for i in get_health(node_name)['timechecks']['mons']:
