...
FUEL_RELEASE_VERSION = os.environ.get('FUEL_RELEASE_VERSION', "9.2")
...
FORCE_DISABLE_UPDATES = get_var_as_bool('FORCE_DISABLE_UPDATES', None)
if FORCE_DISABLE_UPDATES is None:
    FORCE_DISABLE_UPDATES = PATCHING_DISABLE_UPDATES

PATCHING_RUN_RALLY = get_var_as_bool("PATCHING_RUN_RALLY", False)

DOWNLOAD_LINK = os.environ.get(
    'DOWNLOAD_LINK', 'http://ubuntu1.hti.pl/14.04/'
...
UPGRADE_CLUSTER_FROM_PROPOSED = get_var_as_bool(
