...
UPDATE_FUEL_MIRROR_EXLUDE_CENTOS = "*.i?86,*.i686,python-requests*,python-six".split(",")
UPDATE_FUEL_MIRROR_EXLUDE_NAILGUN = "iwl*-firmware*mira*,libertas-*-firmware*mira*,linux-firmware,kernel*3.10.5*mos*,kernel*2.6.3*mos*".split(
    ",")
