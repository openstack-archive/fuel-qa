...
ADMIN_NODE_PUPPET_TIMEOUT = os.environ.get("ADMIN_NODE_PUPPET_TIMEOUT", 1800)
ADMIN_NODE_BUILD_BOOTSTRAP_TIMEOUT = os.environ.get(
    "ADMIN_NODE_BUILD_BOOTSTRAP_TIMEOUT", 2400)
