...
class CreateDeployDelete(actions_base.ActionsBase):
    """Case delete Environment after deploy
    ...
    base_group = ['acceptance', 'acceptance.create_deploy_delete']
    actions_order = [
...
@factory
def cases():
    return case_factory(CreateDeployDelete)
