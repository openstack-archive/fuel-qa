...
class VMwareActions(object):
    ...
    def create_instances(self):
        ...
        net = self.os_conn.get_network(self.internal_net)
    ...
    def ping_from_instance(self, src_floating_ip, dst_ip, primary,
        ...
        :param primary: name of primary controller
    ...
    def check_vm_connect(self):
        ...
        for srv in self.vms_to_ping:
            ...
            private_ips[srv] = self.os_conn.get_nova_instance_ip(
                srv, net_name=self.internal_net)
        ...
        for vm in itertools.combinations(self.vms_to_ping, 2):
            ...
            if not self.ping_from_instance(floating_ips[vm[0]],
                                           private_ips[vm[1]],
                                           primary_ctrl_name):
                raise AssertionError('Ping between VMs failed')
