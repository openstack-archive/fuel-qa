...
from system_test.tests.plugins import plugins_base
from system_test.tests.plugins.plugin_example.test_plugin_example import \
    ExamplePluginActions


class DeployWithPluginExampleV3(plugins_base.PluginsBaseActions,
                                ExamplePluginActions):
