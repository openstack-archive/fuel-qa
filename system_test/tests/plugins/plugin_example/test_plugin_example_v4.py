...
class DeployWithPluginExampleV4PreCreate(ActionsBase):
    ...
    Duration 35m
    Snapshot deploy_ha_one_controller_neutron_example_v4
    """

    base_group = ['system_test',
                  'system_test.plugins',
                  'system_test.plugins.example_plugin_v4',
                  'system_test.plugins.example_plugin_v4.normal']
...
class DeployWithPluginExampleV4PostCreate(ActionsBase):
    ...
    Duration 35m
    Snapshot deploy_ha_one_controller_neutron_example_v4_post_create
    """

    base_group = ['system_test',
                  'system_test.plugins',
                  'system_test.plugins.example_plugin_v4',
                  'system_test.plugins.example_plugin_v4.post_create']
...
class DeployWithPluginExampleV4PostDeploy(ActionsBase):
    """Deploy cluster with one controller and example plugin v4
    ...
    Duration 35m
    Snapshot deploy_ha_one_controller_neutron_example_post_deploy
    """

    base_group = ['system_test',
                  'system_test.plugins',
                  'system_test.plugins.example_plugin_v4',
                  'system_test.plugins.example_plugin_v4.post_deploy']
