...
class CentosDeployCheckRadosGW(ActionTest, BaseActions):
    ...
    Scenario:
        1. Bootstrap Centos node and setup Fuel services
    ...
    @action
    def config_release_centos(self):
        """Config release on Centos master node"""
        self.config_release(centos=True)
