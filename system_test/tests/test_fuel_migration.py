...
class HardComputeRestartAfterMigration(FuelMasterMigrate):
...
class WarmComputeRestartAfterMigration(HardComputeRestartAfterMigration):
    ...
    actions_order = HardComputeRestartAfterMigration.actions_order
