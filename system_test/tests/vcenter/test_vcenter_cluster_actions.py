...
@testcase(groups=['system_test',
                  'system_test.vcenter',
                  'system_test.vcenter.redeploy_successful_cluster'])
...
@testcase(groups=['system_test',
                  'system_test.vcenter',
                  'system_test.vcenter.redeploy_stopped_cluster'])
...
@testcase(groups=['system_test',
                  'system_test.vcenter',
                  'system_test.vcenter.redeploy_failed_cluster'])
