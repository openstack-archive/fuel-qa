...
class FillRootBaseActions(actions_base.ActionsBase):
    ...
    def _action_get_pcs_initial_state(self,):
        ...
        self.slave_node_running_resources = min(int(self.pcs_status[
            self.slave_nodes_fqdn[0]]['resources_running']),
            int(self.pcs_status[self.slave_nodes_fqdn[1]]['resources_running']))
    ...
    def _action_fill_root(self):
        ...
        self.ostf_tests_should_failed += 8
